...
// the RBAC layer. This is the fix for the "TypeScript interface integrity"
// finding in the audit report: one closed definition, used everywhere,
// instead of an ad-hoc `req.user?: any` scattered across files.
