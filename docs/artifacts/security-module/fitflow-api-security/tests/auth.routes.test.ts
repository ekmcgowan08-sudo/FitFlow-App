...
// Integration-style unit tests for after/auth.routes.ts, driven through
// the real Express app (app.ts) with a mocked Prisma client. Each test
// uses a distinct email/refresh token so it doesn't collide with the
