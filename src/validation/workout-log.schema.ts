...
/** Maps the API's SCREAMING_CASE category to the Prisma `ExerciseCategory` enum value. */
export function toExerciseCategory(category: z.infer<typeof workoutCategoryEnum>): ExerciseCategory {
  return category.toLowerCase() as ExerciseCategory;
}
...
/** GET /v1/workout-logs?memberId=&category=&from=&to=&page=&pageSize= */
